class GetDirectionResponseModel {
  List<GeocodedWaypoints>? geocodedWaypoints;
  List<Routes>? routes;
  String? status;

  GetDirectionResponseModel({this.geocodedWaypoints, this.routes, this.status});

  GetDirectionResponseModel.fromJson(Map<String, dynamic> json) {
